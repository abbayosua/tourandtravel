-- Auto-generated: 100 additional China tours (total 150)
SET NAMES utf8mb4;
...
SELECT 'Private Tour ke Mutianyu atau Badaling Great Wall dengan VIP Fast Pass', 'private-tour-ke-mutianyu-atau-badaling-great-wall-dengan-vip-fast-pass', 'Beijing', 'Private Tour ke Mutianyu atau Badaling Great Wall dengan VIP Fast Pass

Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: 1K+ kali dipesan', 4401562.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/e084jofhobfzizgn39ae.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'private-tour-ke-mutianyu-atau-badaling-great-wall-dengan-vip-fast-pass') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'private-tour-ke-mutianyu-atau-badaling-great-wall-dengan-vip-fast-pass' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Private Tour ke Mutianyu atau Badaling Great Wall dengan VIP Fast Pass' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Beijing', 'Day 2: Explore Beijing. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: 300+ kali dipesan', 3615547.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/e7fctrkwm7kwgireuwvt.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-trekking-sehari-penuh-tembok-besar-jinshanling-dengan-transfer') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-trekking-sehari-penuh-tembok-besar-jinshanling-dengan-transfer' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Pengalaman Trekking Sehari Penuh Tembok Besar Jinshanling dengan Transfer' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: 900+ kali dipesan', 2228723.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/naj591by0qpftezezj8t.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadi-unesco-sehari-penuh-beijing-istana-musim-panas-tembok-besar') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadi-unesco-sehari-penuh-beijing-istana-musim-panas-tembok-besar' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Tur Pribadi UNESCO Sehari Penuh Beijing: Istana Musim Panas & Tembok Besar' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 990346.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/sfiaanmknrsqicuyykps.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'suiguokehidupan-pemandian-air-panas-toko-hopson-one') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'suiguokehidupan-pemandian-air-panas-toko-hopson-one' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Suiguo+Kehidupan Pemandian Air Panas | Toko Hopson One' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Konfirmasi instan
Popularity: ', 6952252.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/naw1dla7p95covdiuodf.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjalanan-budaya-3-hari-ke-tembok-besar-mutianyu-dan-kota-terlarang-beijing') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjalanan-budaya-3-hari-ke-tembok-besar-mutianyu-dan-kota-terlarang-beijing' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Perjalanan Budaya 3 Hari ke Tembok Besar Mutianyu dan Kota Terlarang Beijing' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Popularity: 2K+ kali dipesan', 316701.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/bjw4iphrd4wx0bz5uux9.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-1-hari-tembok-besar-badaling-beijing-istana-musim-panastaman-yuanmingyuansarang-burung') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-1-hari-tembok-besar-badaling-beijing-istana-musim-panastaman-yuanmingyuansarang-burung' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Tur 1 Hari Tembok Besar Badaling Beijing + Istana Musim Panas/Taman Yuanmingyuan/Sarang Burung' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 200+ kali dipesan', 499050.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/hr1wiipiunlqn6qhjoij.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-berpemandu-sehari-penuh-ke-tembok-besar-huanghuacheng-di-beijing') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-berpemandu-sehari-penuh-ke-tembok-besar-huanghuacheng-di-beijing' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Tur berpemandu sehari penuh ke Tembok Besar Huanghuacheng di Beijing' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 2236557.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/fgtz470kbrv8n2onmqen.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-tembok-besar-mutianyu-beijing-kota-air-gubei') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-tembok-besar-mutianyu-beijing-kota-air-gubei' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Tur Sehari Tembok Besar Mutianyu Beijing & Kota Air Gubei' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 916987.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/iuuxpgkcophtgg0zhwgg.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-mutianyu-great-wall-temple-of-heaven-beijing') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-mutianyu-great-wall-temple-of-heaven-beijing' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Tur Sehari Mutianyu Great Wall & Temple of Heaven Beijing' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk hari ini; Private tour; Grup pribadi; Pembatalan gratis
Popularity: ', 1473729.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/wju8gskc4ighknuoexxm.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'layanan-pemandu-wisata-beijing') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'layanan-pemandu-wisata-beijing' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Beijing', 'Day 1 di Beijing: Layanan Pemandu Wisata Beijing' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 479270.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/wxxpvzgqukc3sxx2ddgc.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-setengah-hari-budaya-teh-meijiawu-hangzhou-termasuk-upacara-teh-dinasti-song') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-setengah-hari-budaya-teh-meijiawu-hangzhou-termasuk-upacara-teh-dinasti-song' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Pengalaman Setengah Hari Budaya Teh Meijiawu Hangzhou termasuk Upacara Teh Dinasti Song' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Popularity: 50+ kali dipesan', 426399.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/ojlgbkmgqq6ifknhyb03.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-sewa-hanfu-pemotretan-di-suzhou-sewa-hanfu-opsional-pemotretan-di-lokasi-dengan-fotografer-berbagai-pilihan-gaya-pakaian-yang-indah-dan-beragam-layanan-premium-pakaian-b') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-sewa-hanfu-pemotretan-di-suzhou-sewa-hanfu-opsional-pemotretan-di-lokasi-dengan-fotografer-berbagai-pilihan-gaya-pakaian-yang-indah-dan-beragam-layanan-premium-pakaian-b' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Pengalaman Sewa Hanfu & Pemotretan di Suzhou (Sewa Hanfu + Opsional Pemotretan di Lokasi dengan Fotografer + Berbagai Pilihan Gaya + Pakaian yang Indah dan Beragam + Layanan Premium + Pakaian Berkualitas Tinggi)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 926576.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/zcbcidqf3no3pp0evhcs.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-kota-air-suzhou-zhouzhuang-taman-administrator-yang-rendah-hati') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-kota-air-suzhou-zhouzhuang-taman-administrator-yang-rendah-hati' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Tur Sehari Kota Air Suzhou Zhouzhuang & Taman Administrator yang Rendah Hati' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 1488924.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/u1fbdzpedqepycekjb13.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-pribadi-sehari-penuh-di-taman-zhouzheng-kota-air-tongli') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-pribadi-sehari-penuh-di-taman-zhouzheng-kota-air-tongli' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Pengalaman Pribadi Sehari Penuh di Taman Zhouzheng & Kota Air Tongli' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Keberangkatan pagi; Hingga 3 jam; Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 1161508.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/ktmnkuuaqeemi1aedhg8.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-pemotretan-hanfu-3-jam-di-jalan-kuno-danau-barat-hangzhou') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-pemotretan-hanfu-3-jam-di-jalan-kuno-danau-barat-hangzhou' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Pengalaman Pemotretan Hanfu 3 Jam di Jalan Kuno Danau Barat Hangzhou' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis; Konfirmasi instan
Popularity: ', 2396296.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/zntvxudmdd0wqhkdrttp.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-hangzhou-dari-shanghaihangzhou-danau-barat-kuil-lingyin-tiket-kereta-cepat-pulang-pergi-tur-kelompok-kecil-berbahasa-inggris') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-hangzhou-dari-shanghaihangzhou-danau-barat-kuil-lingyin-tiket-kereta-cepat-pulang-pergi-tur-kelompok-kecil-berbahasa-inggris' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Tur Sehari Hangzhou dari Shanghai/Hangzhou | Danau Barat + Kuil Lingyin + Tiket Kereta Cepat Pulang Pergi · Tur Kelompok Kecil Berbahasa Inggris' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Private Day Tour Danau Barat & Kuil Lingyin Hangzhou', 'private-day-tour-danau-barat-kuil-lingyin-hangzhou', 'Shanghai', 'Private Day Tour Danau Barat & Kuil Lingyin Hangzhou

Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 1725350.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/cfjh1ldfqzcdwq7tzi6z.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'private-day-tour-danau-barat-kuil-lingyin-hangzhou') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'private-day-tour-danau-barat-kuil-lingyin-hangzhou' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Private Day Tour Danau Barat & Kuil Lingyin Hangzhou' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 543170.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/ajxvbtaqzqufjoz8r9ln.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-setengah-hari-naik-perahu-danau-barat-hangzhou-dan-pagoda-leifeng') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-setengah-hari-naik-perahu-danau-barat-hangzhou-dan-pagoda-leifeng' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Pengalaman Setengah Hari Naik Perahu Danau Barat Hangzhou dan Pagoda Leifeng' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 383431.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/i88elo8van4j2o2deypt.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-1-hari-pulau-meifeng-danau-qiandaodek-observasi-gunung-tianyu-termasuk-perjalanan-perahu') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-1-hari-pulau-meifeng-danau-qiandaodek-observasi-gunung-tianyu-termasuk-perjalanan-perahu' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shanghai', 'Day 1 di Shanghai: Tur 1 Hari Pulau Meifeng Danau Qiandao/Dek Observasi Gunung Tianyu (Termasuk Perjalanan Perahu)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis
Popularity: 200+ kali dipesan', 499050.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/gxkdypczvrr6nhi0lz59.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-cheongsam-khas-bund-shanghai-opsional-dengan-fotografer-untuk-pemotretan-luar-ruangan') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-cheongsam-khas-bund-shanghai-opsional-dengan-fotografer-untuk-pemotretan-luar-ruangan' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Pengalaman Cheongsam Khas Bund Shanghai (opsional dengan fotografer untuk pemotretan luar ruangan)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Guangzhou', 'Day 2: Explore Guangzhou. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 335486.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/eyya8yegwiuhyyie3tio.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'half-day-guided-tour-di-shanghai-science-technology-museum') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'half-day-guided-tour-di-shanghai-science-technology-museum' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Half-Day Guided Tour di Shanghai Science & Technology Museum' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 200+ kali dipesan', 492553.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/v7d1pvb6kv874rdubg5m.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'shuiguo-tangquan-toko-wujiaochang') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'shuiguo-tangquan-toko-wujiaochang' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Shuiguo · Tangquan | Toko Wujiaochang ' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 399387.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/eqtrbxet8arry39moxoc.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-penuh-shanghai-wuzhen-nanxun-old-towns') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-penuh-shanghai-wuzhen-nanxun-old-towns' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Tur Sehari Penuh Shanghai Wuzhen & Nanxun Old Towns' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: 50+ kali dipesan', 261996.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/uafc9qj9hxencatpifso.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjamuan-shanghai-bulan-menyanyi-perjamuan-hongmen') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjamuan-shanghai-bulan-menyanyi-perjamuan-hongmen' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Perjamuan Shanghai Bulan Menyanyi · Perjamuan Hongmen' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Reservasi di aplikasi; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 413954.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/k5bembmyjnax9l3xnkm5.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'terapi-kepala-sirkulasi-air-musim-semi-empat-musim-pembersihan-wajah-pijat-spa-toko-gedung-puhui') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'terapi-kepala-sirkulasi-air-musim-semi-empat-musim-pembersihan-wajah-pijat-spa-toko-gedung-puhui' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Terapi Kepala Sirkulasi Air Musim Semi Empat Musim · Pembersihan Wajah · Pijat SPA | Toko Gedung Puhui' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk hari ini; Pembatalan gratis; Konfirmasi instan
Popularity: 300+ kali dipesan', 0.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/h6nqjeavy6htyaldx3zd.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'authentic-local-food-tour-di-central-shanghai') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'authentic-local-food-tour-di-central-shanghai' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Authentic Local Food Tour di Central Shanghai' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 0.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/a62bure8tc8ny3grvhn0.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'full-day-tour-dengan-pemandu-ke-shanghai-film-park-zhujiajiao-water-town') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'full-day-tour-dengan-pemandu-ke-shanghai-film-park-zhujiajiao-water-town' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Full-Day Tour dengan Pemandu ke Shanghai Film Park & Zhujiajiao Water Town' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Konfirmasi instan
Popularity: 200+ kali dipesan', 440154.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/f41vfkn8ximeugrxxdvz.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'taste-of-china-restoran-imersif-rasa') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'taste-of-china-restoran-imersif-rasa' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: TASTE OF CHINA Restoran Imersif Rasa' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Grup pribadi; Pembatalan gratis
Popularity: 50+ kali dipesan', 415369.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/bzmceck9qpwyfxy9xubq.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'hanfu-butik-shanghai-yu-garden-perjalanan-fotografer-mengikuti-pemotretan-di-lokasi') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'hanfu-butik-shanghai-yu-garden-perjalanan-fotografer-mengikuti-pemotretan-di-lokasi' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Guangzhou', 'Day 1 di Guangzhou: Hanfu Butik Shanghai Yu Garden · Perjalanan (Fotografer Mengikuti Pemotretan di Lokasi)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Private tour; Pembatalan gratis
Popularity: 400+ kali dipesan', 383405.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/xqduooaxh3mhtd1lbgib.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-setengah-hari-di-museum-sejarah-shaanxi-pertunjukan-khas-dapat-digabungkan') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-setengah-hari-di-museum-sejarah-shaanxi-pertunjukan-khas-dapat-digabungkan' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shenzhen', 'Day 1 di Shenzhen: Tur setengah hari di Museum Sejarah Shaanxi (pertunjukan khas dapat digabungkan)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 1086420.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/xzombuivtvsepdag6qid.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tiket-terra-cotta-warriors-dengan-layanan-pemandu-atau-transportasi-opsional') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tiket-terra-cotta-warriors-dengan-layanan-pemandu-atau-transportasi-opsional' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shenzhen', 'Day 1 di Shenzhen: Tiket Terra-cotta Warriors dengan Layanan Pemandu atau Transportasi Opsional' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 1118278.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/t03gztledq4ptk99owz1.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-jalan-kaki-makanan-lokal-budaya-3-jam-di-muslim-quarter') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-jalan-kaki-makanan-lokal-budaya-3-jam-di-muslim-quarter' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Shenzhen', 'Day 1 di Shenzhen: Tur Jalan Kaki Makanan Lokal & Budaya 3 Jam di Muslim Quarter' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Tur 5 Hari Terbalik ke Alam Rahasia Gunung Genyen di Awan (Gunung Siguniang + Mata Genyen + Taman Batu Tinta + Yuzixi)', 'tur-5-hari-terbalik-ke-alam-rahasia-gunung-genyen-di-awan-gunung-siguniang-mata-genyen-taman-batu-tinta-yuzixi', 'Chengdu', 'Tur 5 Hari Terbalik ke Alam Rahasia Gunung Genyen di Awan (Gunung Siguniang + Mata Genyen + Taman Batu Tinta + Yuzixi)

Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 5763916.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/bmpsnemnqwhnvc56kz0u.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-5-hari-terbalik-ke-alam-rahasia-gunung-genyen-di-awan-gunung-siguniang-mata-genyen-taman-batu-tinta-yuzixi') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-5-hari-terbalik-ke-alam-rahasia-gunung-genyen-di-awan-gunung-siguniang-mata-genyen-taman-batu-tinta-yuzixi' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur 5 Hari Terbalik ke Alam Rahasia Gunung Genyen di Awan (Gunung Siguniang + Mata Genyen + Taman Batu Tinta + Yuzixi)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Chengdu', 'Day 2: Explore Chengdu. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;

INSERT IGNORE INTO tour_images (tour_id, image_path, caption, sort_order) SELECT @tid, 'https://res.klook.com/image/upload/activities/bmpsnemnqwhnvc56kz0u.jpg', 'Tur 5 Hari Terbalik ke Alam Rahasia Gunung Genyen di Awan (Gunung Siguniang + Mata Genyen + Taman Batu Tinta + Yuzixi)', 0 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_images WHERE tour_id = @tid AND image_path = 'https://res.klook.com/image/upload/activities/bmpsnemnqwhnvc56kz0u.jpg') LIMIT 1;

INSERT IGNORE INTO tour_dates (tour_id, departure_date, return_date, available_slots, is_active) SELECT @tid, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 37 DAY), 19, 1 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_dates WHERE tour_id = @tid) LIMIT 1;

INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Tur Sehari Panda Chengdu & Buddha Raksasa Leshan', 'tur-sehari-panda-chengdu-buddha-raksasa-leshan', 'Chengdu', 'Tur Sehari Panda Chengdu & Buddha Raksasa Leshan

Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 1053225.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/zpgbu2s2gf7k2xmcqtif.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-panda-chengdu-buddha-raksasa-leshan') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-panda-chengdu-buddha-raksasa-leshan' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur Sehari Panda Chengdu & Buddha Raksasa Leshan' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 2090730.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/dlzppfvkmkevovmvapks.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-2-hari-gunung-emei-sichuan-dan-buddha-raksasa-leshan-opsional-tur-pribadi-berbahasa-inggris') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-2-hari-gunung-emei-sichuan-dan-buddha-raksasa-leshan-opsional-tur-pribadi-berbahasa-inggris' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur 2 Hari Gunung Emei Sichuan dan Buddha Raksasa Leshan (Opsional Tur Pribadi Berbahasa Inggris)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: ', 7806858.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/w8ibposhsismdjn9yfmk.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-6-hari-lintas-sichuan-barat-jalur-selatan-genyen-mata-genyen-lenggacuo-yuzixi-cuopugou-lembah-sungai-reti-jiagenba') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-6-hari-lintas-sichuan-barat-jalur-selatan-genyen-mata-genyen-lenggacuo-yuzixi-cuopugou-lembah-sungai-reti-jiagenba' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur 6 Hari Lintas Sichuan Barat Jalur Selatan Genyen (Mata Genyen + Lenggacuo + Yuzixi + Cuopugou + Lembah Sungai Reti + Jiagenba)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 980888.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/cx2g2hwqqzndh0tsg29p.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-di-chengdu-pangkalan-panda-eksplorasi-museum-sanxingdui') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-di-chengdu-pangkalan-panda-eksplorasi-museum-sanxingdui' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur Sehari di Chengdu: Pangkalan Panda & Eksplorasi Museum Sanxingdui' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Chengdu', 'Day 2: Explore Chengdu. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;

INSERT IGNORE INTO tour_images (tour_id, image_path, caption, sort_order) SELECT @tid, 'https://res.klook.com/image/upload/activities/cx2g2hwqqzndh0tsg29p.jpg', 'Tur Sehari di Chengdu: Pangkalan Panda & Eksplorasi Museum Sanxingdui', 0 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_images WHERE tour_id = @tid AND image_path = 'https://res.klook.com/image/upload/activities/cx2g2hwqqzndh0tsg29p.jpg') LIMIT 1;

INSERT IGNORE INTO tour_dates (tour_id, departure_date, return_date, available_slots, is_active) SELECT @tid, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 37 DAY), 7, 1 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_dates WHERE tour_id = @tid) LIMIT 1;

INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Tur Pribadi Sehari Penuh Dujiangyan dan Lembah Panda Chengdu', 'tur-pribadi-sehari-penuh-dujiangyan-dan-lembah-panda-chengdu', 'Chengdu', 'Tur Pribadi Sehari Penuh Dujiangyan dan Lembah Panda Chengdu

Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 200+ kali dipesan', 1597548.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/f4sbrmu6eqkawrdyakld.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadi-sehari-penuh-dujiangyan-dan-lembah-panda-chengdu') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadi-sehari-penuh-dujiangyan-dan-lembah-panda-chengdu' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur Pribadi Sehari Penuh Dujiangyan dan Lembah Panda Chengdu' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: ', 4608041.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/wtzp0jqkhmm2lsdyjzyw.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-4-hari-gunung-siguniang-taman-moshigong-yuzixi-lenggacuo-2-8-orang') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-4-hari-gunung-siguniang-taman-moshigong-yuzixi-lenggacuo-2-8-orang' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur 4 Hari Gunung Siguniang, Taman Moshigong, Yuzixi, Lenggacuo (2-8 orang)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 0.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/v07vig9clftqyafec6ql.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'chengdu-du-fu-thatched-cottage-wuhou-shrine-full-day-food-experience') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'chengdu-du-fu-thatched-cottage-wuhou-shrine-full-day-food-experience' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Chengdu Du Fu Thatched Cottage & Wuhou Shrine Full-Day Food Experience' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 1278017.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/xxryh1wgtbzpzhadgzd1.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadi-sehari-penuh-pangkalan-panda-wolong-chengdu') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadi-sehari-penuh-pangkalan-panda-wolong-chengdu' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Tur Pribadi Sehari Penuh Pangkalan Panda Wolong Chengdu' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: 50+ kali dipesan', 259376.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/dd1xlvth5vyewcqzjb8u.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'penyewaan-hanfu-dan-pengalaman-pemotretan-di-chengdu-chunxi-road') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'penyewaan-hanfu-dan-pengalaman-pemotretan-di-chengdu-chunxi-road' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chengdu', 'Day 1 di Chengdu: Penyewaan Hanfu dan Pengalaman Pemotretan di Chengdu Chunxi Road' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: ', 285576.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/h6pgxix0gjwsn35blycc.jpg', 1
...
Tags: Pesan untuk besok
Popularity: ', 1590684.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/cfckbsqo8cjbc7jnc3k8.jpg', 1
...
Tags: Pesan untuk besok; Pembatalan gratis
Popularity: ', 1291274.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/bugnkku9rs64zw3pxyv2.jpg', 1
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 575108.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/vfjtfytkenefrkyow6le.jpg', 1
...
INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Tur Sehari Kota Guilin: Kota Kuno Pinggiran Kota dan Gua Seruling Buluh', 'tur-sehari-kota-guilin-kota-kuno-pinggiran-kota-dan-gua-seruling-buluh', 'Xi'an', 'Tur Sehari Kota Guilin: Kota Kuno Pinggiran Kota dan Gua Seruling Buluh

Tags: Penjemputan hotel; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 1801224.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/mlrsnqky6qups4jgd82f.jpg', 1
...
Tags: Pesan untuk besok; Private tour; Keberangkatan sore/malam; Pembatalan gratis
Popularity: 50+ kali dipesan', 998074.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/gl2h3csvbwfuovhf0mxy.jpg', 1
...
Tags: Private tour; Pembatalan gratis
Popularity: ', 0.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/gc4h9zwmzw2ugiaojjyh.jpg', 1
...
Tags: Keberangkatan pagi; Hingga 3 jam; Pembatalan gratis
Popularity: ', 857723.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/jqkkmge26vpj671dqqep.jpg', 1
...
Tags: Private tour; Grup pribadi; Pembatalan gratis
Popularity: ', 2220575.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/klngwkus0xtnsoquypjo.jpg', 1
...
Tags: Pesan untuk besok; Private tour; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 3739681.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/h5rpcvj4tmwjvy8eynuh.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-mewah-panorama-penuh-beberapa-hari-di-hunan-changsha-zhangjiajie-fenghuang') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-mewah-panorama-penuh-beberapa-hari-di-hunan-changsha-zhangjiajie-fenghuang' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Tur Mewah Panorama Penuh Beberapa Hari di Hunan Changsha Zhangjiajie Fenghuang' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Hangzhou', 'Day 2: Explore Hangzhou. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: 50+ kali dipesan', 766810.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/v2qzsmwkxczngluuejfb.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-penuh-zhangjiajie-glass-bridge-tianmen-mountain') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-penuh-zhangjiajie-glass-bridge-tianmen-mountain' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Tur Sehari Penuh Zhangjiajie Glass Bridge & Tianmen Mountain' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Keberangkatan sore/malam; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 464729.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/z06aromawyxwsicevobm.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pertunjukan-zhangjiajie-tianmen-fox-fairy-transportasi-pribadi-pulang-pergi-pemandangan-nyata-pegunungan-dan-sungai-yang-fantastis-pesta-visual-dan-pendengaran-yang-mengejutkan') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pertunjukan-zhangjiajie-tianmen-fox-fairy-transportasi-pribadi-pulang-pergi-pemandangan-nyata-pegunungan-dan-sungai-yang-fantastis-pesta-visual-dan-pendengaran-yang-mengejutkan' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Pertunjukan Zhangjiajie Tianmen Fox Fairy + transportasi pribadi pulang pergi (pemandangan nyata pegunungan dan sungai yang fantastis, pesta visual dan pendengaran yang mengejutkan)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 798774.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/opst29j7alomvahggrcy.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-9-tempat-teratas-zhangjiajie-dengan-lewati-antrean') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-9-tempat-teratas-zhangjiajie-dengan-lewati-antrean' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Tur Sehari 9 Tempat Teratas Zhangjiajie dengan Lewati Antrean' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Pembatalan gratis; Konfirmasi instan
Popularity: 200+ kali dipesan', 462345.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/ortityi9gxphoowhwafd.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-taman-hutan-nasional-gunung-tianmen-zhangjiajie-saluran-vip-opsional') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-taman-hutan-nasional-gunung-tianmen-zhangjiajie-saluran-vip-opsional' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Tur Sehari Taman Hutan Nasional Gunung Tianmen Zhangjiajie (Saluran VIP Opsional)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis
Popularity: 50+ kali dipesan', 5611094.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/lup4bz82tqchn7c4wyfl.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'panduan-bahasa-inggris-tur-dua-lima-hari-kota-furong-mnt-avatar-untuk-enam-orang') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'panduan-bahasa-inggris-tur-dua-lima-hari-kota-furong-mnt-avatar-untuk-enam-orang' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Panduan Bahasa Inggris Tur Dua-Lima Hari Kota Furong Mnt-Avatar untuk Enam Orang' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: ', 1309981.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/anmyn8uyffpdvvnau5x6.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-sehari-penuh-jembatan-kaca-zhangjiajie-gua-naga-kuning') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-sehari-penuh-jembatan-kaca-zhangjiajie-gua-naga-kuning' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Pengalaman Sehari Penuh Jembatan Kaca Zhangjiajie & Gua Naga Kuning' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 405492.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/udmqnsf5j9ma4xxxcybf.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-setengah-hari-kota-kuno-xiangxi-furong-dengan-tiket') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-setengah-hari-kota-kuno-xiangxi-furong-dengan-tiket' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Tur Setengah Hari Kota Kuno Xiangxi Furong dengan Tiket' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Grup kecil; Pembatalan gratis
Popularity: 100+ kali dipesan', 6379607.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/usu8wtotau5m9svs4ea2.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjalanan-ke-zhangjiajie-kota-kuno-fenghuang-zhangjiajie-hunan-5-hari-4-malam') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjalanan-ke-zhangjiajie-kota-kuno-fenghuang-zhangjiajie-hunan-5-hari-4-malam' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Perjalanan ke Zhangjiajie | Kota Kuno Fenghuang, Zhangjiajie, Hunan 5 Hari 4 Malam' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis
Popularity: ', 6234880.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/zvg3gqdcmrmnezeombfl.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-beberapa-hari-eksklusif-zhangjiajie-avatar-ajaib-tianmen-secret-realm-pemandu-berbahasa-inggris-opsional') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-beberapa-hari-eksklusif-zhangjiajie-avatar-ajaib-tianmen-secret-realm-pemandu-berbahasa-inggris-opsional' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Hangzhou', 'Day 1 di Hangzhou: Tur beberapa hari eksklusif Zhangjiajie Avatar Ajaib + Tianmen Secret Realm (pemandu berbahasa Inggris opsional)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: 100+ kali dipesan', 259402.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/dbuo5scbbinxulud2aan.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'dali-lisong-banquet-pengalaman-perjamuan-kerajaan-yang-imersif') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'dali-lisong-banquet-pengalaman-perjamuan-kerajaan-yang-imersif' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Dali Lisong Banquet: Pengalaman Perjamuan Kerajaan yang Imersif' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Zhangjiajie', 'Day 2: Explore Zhangjiajie. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;
...
Tags: Pesan untuk besok; Keberangkatan pagi; 3-5 jam; Pembatalan gratis; Konfirmasi instan
Popularity: ', 975936.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/sso5ffkn7odynagxwypj.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tuan-rumah-suku-naxi-mengajak-anda-menjelajahi-pasar-etnis-minoritas-membuat-makanan-khas-naxi') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tuan-rumah-suku-naxi-mengajak-anda-menjelajahi-pasar-etnis-minoritas-membuat-makanan-khas-naxi' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Tuan rumah suku Naxi mengajak Anda menjelajahi pasar etnis minoritas, membuat makanan khas Naxi' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis; Konfirmasi instan
Popularity: ', 964906.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/rukjamxdcmn8i3kvj4qr.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-wisata-sehari-penuh-pemandangan-danau-fuxian-kunming') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-wisata-sehari-penuh-pemandangan-danau-fuxian-kunming' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Tur wisata sehari penuh Pemandangan Danau Fuxian Kunming' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Zhangjiajie', 'Day 2: Explore Zhangjiajie. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;

INSERT IGNORE INTO tour_images (tour_id, image_path, caption, sort_order) SELECT @tid, 'https://res.klook.com/image/upload/activities/rukjamxdcmn8i3kvj4qr.jpg', 'Tur wisata sehari penuh Pemandangan Danau Fuxian Kunming', 0 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_images WHERE tour_id = @tid AND image_path = 'https://res.klook.com/image/upload/activities/rukjamxdcmn8i3kvj4qr.jpg') LIMIT 1;

INSERT IGNORE INTO tour_dates (tour_id, departure_date, return_date, available_slots, is_active) SELECT @tid, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 37 DAY), 14, 1 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_dates WHERE tour_id = @tid) LIMIT 1;

INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Tur Yunnan 7 hari ke tempat-tempat wisata utama', 'tur-yunnan-7-hari-ke-tempat-tempat-wisata-utama', 'Zhangjiajie', 'Tur Yunnan 7 hari ke tempat-tempat wisata utama

Tags: Private tour; Konfirmasi instan
Popularity: 100+ kali dipesan', 0.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/p9sa0vxsrwtps8ctgmrq.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-yunnan-7-hari-ke-tempat-tempat-wisata-utama') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-yunnan-7-hari-ke-tempat-tempat-wisata-utama' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Tur Yunnan 7 hari ke tempat-tempat wisata utama' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Private tour; Grup pribadi
Popularity: 50+ kali dipesan', 10843210.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/xf0hs653kwxucxkedcrm.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadi-5-hari-4-malam-ke-kunming-dali-lijiang-dan-shangri-la') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadi-5-hari-4-malam-ke-kunming-dali-lijiang-dan-shangri-la' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Tur Pribadi 5 Hari 4 Malam ke Kunming, Dali, Lijiang, dan Shangri-La' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: 
Popularity: 50+ kali dipesan', 7021498.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/roqyimlqtm04srfcguvw.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjalanan-57-hari-ke-yunnan-dali-lijiang-shangri-la') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjalanan-57-hari-ke-yunnan-dali-lijiang-shangri-la' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Perjalanan 5/7 Hari ke Yunnan, Dali, Lijiang & Shangri-La' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Keberangkatan siang
Popularity: ', 11213437.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/ejmzoedb3n4cb7ccpz80.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadijianshuimaitreyadanau-fuxianpuzheheikamtengyuanyang-5-hari-tur-pribadi-di-yunnan-tenggara') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadijianshuimaitreyadanau-fuxianpuzheheikamtengyuanyang-5-hari-tur-pribadi-di-yunnan-tenggara' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: 【Tur Pribadi】Jianshui+Maitreya+Danau Fuxian+Puzhehei/Kamteng/Yuanyang 5 Hari Tur Pribadi di Yunnan Tenggara' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: ', 1680601.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/faryleyid93cpmznib2p.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-grup-kecil-mandiri-dari-lijiang-ke-shangri-la-ngarai-harimau-melompat-danau-napa-dan-biara-songzanlin') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-grup-kecil-mandiri-dari-lijiang-ke-shangri-la-ngarai-harimau-melompat-danau-napa-dan-biara-songzanlin' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Tur sehari grup kecil mandiri dari Lijiang ke Shangri-La, Ngarai Harimau Melompat, Danau Napa, dan Biara Songzanlin' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: 
Popularity: ', 2595020.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/felmcxcjrqzh3kmnaiaq.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-3-hari-lijiang-meili-snow-mountain-dan-grup-kecil-shangri-la') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-3-hari-lijiang-meili-snow-mountain-dan-grup-kecil-shangri-la' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Tur 3 hari Lijiang Meili Snow Mountain dan Grup Kecil Shangri-La' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Zhangjiajie', 'Day 2: Explore Zhangjiajie. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;

INSERT IGNORE INTO tour_images (tour_id, image_path, caption, sort_order) SELECT @tid, 'https://res.klook.com/image/upload/activities/felmcxcjrqzh3kmnaiaq.jpg', 'Tur 3 hari Lijiang Meili Snow Mountain dan Grup Kecil Shangri-La', 0 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_images WHERE tour_id = @tid AND image_path = 'https://res.klook.com/image/upload/activities/felmcxcjrqzh3kmnaiaq.jpg') LIMIT 1;

INSERT IGNORE INTO tour_dates (tour_id, departure_date, return_date, available_slots, is_active) SELECT @tid, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 37 DAY), 18, 1 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_dates WHERE tour_id = @tid) LIMIT 1;

INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Tur Pribadi Lijiang 1 Hari: Gunung Salju Yulong, Padang Rumput Spruce, Kereta Gantung Yak Meadow, Kota Kuno Baisha', 'tur-pribadi-lijiang-1-hari-gunung-salju-yulong-padang-rumput-spruce-kereta-gantung-yak-meadow-kota-kuno-baisha', 'Zhangjiajie', 'Tur Pribadi Lijiang 1 Hari: Gunung Salju Yulong, Padang Rumput Spruce, Kereta Gantung Yak Meadow, Kota Kuno Baisha

Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: ', 1552799.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/q5dg2wmcuzrwvriat9z6.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadi-lijiang-1-hari-gunung-salju-yulong-padang-rumput-spruce-kereta-gantung-yak-meadow-kota-kuno-baisha') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadi-lijiang-1-hari-gunung-salju-yulong-padang-rumput-spruce-kereta-gantung-yak-meadow-kota-kuno-baisha' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Zhangjiajie', 'Day 1 di Zhangjiajie: Tur Pribadi Lijiang 1 Hari: Gunung Salju Yulong, Padang Rumput Spruce, Kereta Gantung Yak Meadow, Kota Kuno Baisha' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Konfirmasi instan
Popularity: 50+ kali dipesan', 0.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/o9xi2tpapnmvrysqpgbl.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadi-6-hari-harbin-ice-and-snow-world-snow-town') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadi-6-hari-harbin-ice-and-snow-world-snow-town' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Tur Pribadi 6 Hari Harbin Ice and Snow World & Snow Town' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Chongqing', 'Day 2: Explore Chongqing. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;
...
Tags: Grup kecil
Popularity: ', 16873812.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/ms1fflmhykyolq0hilzw.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-10-hari-harbin-xuexiang-gunung-changbai-mohe') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-10-hari-harbin-xuexiang-gunung-changbai-mohe' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Tur 10 Hari Harbin & Xuexiang & Gunung Changbai & Mohe' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Private tour
Popularity: 100+ kali dipesan', 4675374.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/aamncwfmz0jjlm5vnhnd.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-4-hari-dongeng-es-dan-salju-di-harbin-yabuli-xuexiang-tiongkok-timur-laut') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-4-hari-dongeng-es-dan-salju-di-harbin-yabuli-xuexiang-tiongkok-timur-laut' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Tur 4 Hari Dongeng Es dan Salju di Harbin Yabuli Xuexiang, Tiongkok Timur Laut' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: ', 389877.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/rsqtdkypr8mq70lp2rrn.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-berpemandu-kelompok-kecil-ke-museum-unit-731-selama-15-jam') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-berpemandu-kelompok-kecil-ke-museum-unit-731-selama-15-jam' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Tur berpemandu kelompok kecil ke Museum Unit 731 selama 1,5 jam' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Private tour
Popularity: ', 8905250.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/ysbtufrexkuy6nktqcp0.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'mohe-bertemu-xuexiang-tur-7-hari-harbin-mohe-xuexiang-di-timur-laut') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'mohe-bertemu-xuexiang-tur-7-hari-harbin-mohe-xuexiang-di-timur-laut' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Mohe bertemu Xuexiang | Tur 7 Hari Harbin + Mohe + Xuexiang di Timur Laut' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: 
Popularity: ', 3274952.0, 'IDR', NULL, 20, 5.0, 0, 'https://res.klook.com/image/upload/activities/thvyqh9jjkv6gclwduge.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'eksplorasi-salju-musim-dingin-multi-hari-yabuli-snow-village') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'eksplorasi-salju-musim-dingin-multi-hari-yabuli-snow-village' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Eksplorasi Salju Musim Dingin Multi-Hari Yabuli & Snow Village' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: 
Popularity: 400+ kali dipesan', 4241849.0, 'IDR', NULL, 20, 4.9, 0, 'https://res.klook.com/image/upload/activities/rbbyamkbutjzbuoekwc9.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-5-hari-dunia-es-dan-salju-harbin-yabuli-desa-salju') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-5-hari-dunia-es-dan-salju-harbin-yabuli-desa-salju' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Tur 5 hari Dunia Es dan Salju Harbin & Yabuli & Desa Salju' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Private tour
Popularity: 400+ kali dipesan', 6023292.0, 'IDR', NULL, 20, 4.9, 0, 'https://res.klook.com/image/upload/activities/bu3yevu63zpbctleh5tv.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pra-penjualan-musim-dinginperjalanan-kereta-api-negeri-salju-harbin-ke-mohe-pulang-pergi-5-hari') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pra-penjualan-musim-dinginperjalanan-kereta-api-negeri-salju-harbin-ke-mohe-pulang-pergi-5-hari' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: 【Pra-penjualan Musim Dingin】Perjalanan Kereta Api Negeri Salju Harbin ke Mohe Pulang Pergi 5 Hari' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Chongqing', 'Day 2: Explore Chongqing. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;

INSERT IGNORE INTO tour_images (tour_id, image_path, caption, sort_order) SELECT @tid, 'https://res.klook.com/image/upload/activities/bu3yevu63zpbctleh5tv.jpg', '【Pra-penjualan Musim Dingin】Perjalanan Kereta Api Negeri Salju Harbin ke Mohe Pulang Pergi 5 Hari', 0 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_images WHERE tour_id = @tid AND image_path = 'https://res.klook.com/image/upload/activities/bu3yevu63zpbctleh5tv.jpg') LIMIT 1;

INSERT IGNORE INTO tour_dates (tour_id, departure_date, return_date, available_slots, is_active) SELECT @tid, DATE_ADD(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 37 DAY), 18, 1 WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM tour_dates WHERE tour_id = @tid) LIMIT 1;

INSERT IGNORE INTO tours (title, slug, category, description, price, price_currency, original_price, max_participants, rating, total_reviews, cover_image, is_active)
SELECT 'Tur Sehari ke Desa Salju', 'tur-sehari-ke-desa-salju', 'Chongqing', 'Tur Sehari ke Desa Salju

Tags: Private tour; Pembatalan gratis; Konfirmasi instan
Popularity: 100+ kali dipesan', 1566737.0, 'IDR', NULL, 20, 4.9, 0, 'https://res.klook.com/image/upload/activities/lsvxlsbfsntwx6u3xoex.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-ke-desa-salju') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-ke-desa-salju' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Tur Sehari ke Desa Salju' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Private tour; Grup pribadi
Popularity: 1K+ kali dipesan', 0.0, 'IDR', NULL, 20, 4.8, 0, 'https://res.klook.com/image/upload/activities/yebsjzf4eihchiqmtzrh.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjalanan-klook-tiongkok-timur-laut-yang-disesuaikan-harbinjilinyanjishenyang') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjalanan-klook-tiongkok-timur-laut-yang-disesuaikan-harbinjilinyanjishenyang' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Chongqing', 'Day 1 di Chongqing: Perjalanan Klook Tiongkok Timur Laut yang Disesuaikan (Harbin/Jilin/Yanji/Shenyang)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Konfirmasi instan
Popularity: 300+ kali dipesan', 0.0, 'IDR', NULL, 20, 4.8, 0, 'https://res.klook.com/image/upload/activities/jjmiwrp88ixf4uwlanqw.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjalanan-kustom-pribadi-klook-di-daratan-tiongkok-fujian-xiamen-xiamenzhangzhouquanzhou') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjalanan-kustom-pribadi-klook-di-daratan-tiongkok-fujian-xiamen-xiamenzhangzhouquanzhou' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Perjalanan Kustom Pribadi Klook di Daratan Tiongkok, Fujian, Xiamen (Xiamen/Zhangzhou/Quanzhou)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description, meals, accommodation) SELECT @tid, 2, 'Day 2 — Yunnan', 'Day 2: Explore Yunnan. Free day.', 'Breakfast', 'Hotel' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 2) LIMIT 1;
...
Tags: Pesan untuk besok; Private tour; Grup pribadi; Pembatalan gratis; Konfirmasi instan
Popularity: ', 2807106.0, 'IDR', NULL, 20, 4.7, 0, 'https://res.klook.com/image/upload/activities/cncphvmh15ojderrppy0.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-pribadi-sepanjang-hari-xiamen-yongding-tulou-dan-yunshuiyao-dengan-mobil-sewaan') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-pribadi-sepanjang-hari-xiamen-yongding-tulou-dan-yunshuiyao-dengan-mobil-sewaan' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Tur Pribadi Sepanjang Hari Xiamen Yongding Tulou dan Yunshuiyao dengan Mobil Sewaan' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis
Popularity: ', 343084.0, 'IDR', NULL, 20, 4.5, 0, 'https://res.klook.com/image/upload/activities/oljmx5tfohljyt6xhdp2.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-kapal-pesiar-15-jam-di-xiamen-kinmen') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-kapal-pesiar-15-jam-di-xiamen-kinmen' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Pengalaman Kapal Pesiar 1,5 Jam di Xiamen Kinmen' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis; Konfirmasi instan
Popularity: ', 1278017.0, 'IDR', NULL, 20, 4.5, 0, 'https://res.klook.com/image/upload/activities/z8xh1ksexkapalboc6en.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'tur-sehari-di-gulangyu-xiamen-fujian-fan-po-lou') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'tur-sehari-di-gulangyu-xiamen-fujian-fan-po-lou' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Tur sehari di Gulangyu, Xiamen, Fujian + Fan Po Lou' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: ', 362865.0, 'IDR', NULL, 20, 4.3, 0, 'https://res.klook.com/image/upload/activities/az6sljcq5b3chaq9uifv.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-berlayar-di-xiamen-upgrade-gratis-ke-perahu-layar-pengalaman-berlayar-di-ombak-cagar-alam-lumba-lumba-liar-termasuk-asuransi-kecelakaan') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-berlayar-di-xiamen-upgrade-gratis-ke-perahu-layar-pengalaman-berlayar-di-ombak-cagar-alam-lumba-lumba-liar-termasuk-asuransi-kecelakaan' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Pengalaman Berlayar di Xiamen (Upgrade Gratis ke Perahu Layar + Pengalaman Berlayar di Ombak + Cagar Alam Lumba-lumba Liar + Termasuk Asuransi Kecelakaan)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pesan untuk besok; Pembatalan gratis
Popularity: 300+ kali dipesan', 360978.0, 'IDR', NULL, 20, 4.1, 0, 'https://res.klook.com/image/upload/activities/szwkdiimmfbynclihebn.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjamuan-kekaisaran-imersif-xiamen-huangdu-liyan') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjamuan-kekaisaran-imersif-xiamen-huangdu-liyan' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Perjamuan Kekaisaran Imersif Xiamen Huangdu Liyan' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Grup kecil
Popularity: ', 2881958.0, 'IDR', NULL, 20, 0.0, 0, 'https://res.klook.com/image/upload/activities/mpxd6vsrsbgrbwjdzmj9.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjalanan-romantis-3-hari-ke-yunshuiyao-gulangyu-fujian') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjalanan-romantis-3-hari-ke-yunshuiyao-gulangyu-fujian' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Perjalanan Romantis 3 Hari ke Yunshuiyao & Gulangyu, Fujian' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis; Konfirmasi instan
Popularity: ', 511207.0, 'IDR', NULL, 20, 0.0, 0, 'https://res.klook.com/image/upload/activities/jkvyy9n2ucakcmrolx4g.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'xiamen-yongding-tulou-chengqilou-full-day-tour') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'xiamen-yongding-tulou-chengqilou-full-day-tour' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Xiamen Yongding Tulou & Chengqilou Full-Day Tour' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Pembatalan gratis
Popularity: ', 259376.0, 'IDR', NULL, 20, 0.0, 0, 'https://res.klook.com/image/upload/activities/jvtkfj8eblc63e9dzyeb.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'pengalaman-pemotretan-zanhua-di-xiamen-gulangyu-foto-zanhua-super-keren-riasan-opsional-fotografer-opsional-mengikuti-pemotretan-luar-ruangan-berbagai-pilihan-gaya') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'pengalaman-pemotretan-zanhua-di-xiamen-gulangyu-foto-zanhua-super-keren-riasan-opsional-fotografer-opsional-mengikuti-pemotretan-luar-ruangan-berbagai-pilihan-gaya' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Pengalaman Pemotretan Zanhua di Xiamen Gulangyu (Foto Zanhua Super Keren + Riasan Opsional + Fotografer Opsional Mengikuti Pemotretan Luar Ruangan + Berbagai Pilihan Gaya)' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;
...
Tags: Grup kecil
Popularity: ', 3848855.0, 'IDR', NULL, 20, 0.0, 0, 'https://res.klook.com/image/upload/activities/uidxows12nyag8ckrxoz.jpg', 1
WHERE NOT EXISTS (SELECT 1 FROM tours WHERE slug = 'perjalanan-sastra-dan-seni-4-hari-di-xiamen') LIMIT 1;
SET @tid = (SELECT id FROM tours WHERE slug = 'perjalanan-sastra-dan-seni-4-hari-di-xiamen' LIMIT 1);

INSERT IGNORE INTO itineraries (tour_id, day_number, title, description) SELECT @tid, 1, 'Day 1 — Yunnan', 'Day 1 di Yunnan: Perjalanan Sastra dan Seni 4 Hari di Xiamen' WHERE @tid IS NOT NULL AND NOT EXISTS (SELECT 1 FROM itineraries WHERE tour_id = @tid AND day_number = 1) LIMIT 1;

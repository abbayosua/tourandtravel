<?php
$pageTitle = 'Pengaturan Mata Uang';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['refresh_rates'])) {
        ...
        if ($rates) {
            ...
            $error = 'Gagal mengambil kurs dari Frankfurter API';
        }
    }
}
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body">
                <form method="POST">
                    <div class="mb-3">
                        <label class="form-label small fw-semibold">Mata uang yang ditampilkan ke pengunjung</label>
    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                <h6 class="fw-bold mb-0"><i class="bi bi-graph-up me-2"></i>Kurs Terkini (EUR Base)</h6>
            ...
            <div class="card-body">
                <?php if ($currentRates): ?>
                    <table class="table table-sm mb-0">
                        <thead>
                            <tr><th>Pasangan</th><th class="text-end">Rate</th></tr>
                        </thead>
                        <tbody>
                    ...
                    <p class="text-muted small mt-2 mb-0">Sumber: <a href="https://frankfurter.app" target="_blank">Frankfurter API</a> — update setiap 24 jam</p>
                <?php else: ?>
                    <p class="text-muted mb-0">Belum ada data kurs. Klik "Refresh" untuk mengambil data terbaru.</p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <h6 class="fw-bold small">Contoh Konversi dari IDR 10.000.000</h6>
                <?php
                $sampleIDR = 10000000;

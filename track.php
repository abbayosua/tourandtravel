            ...
            <div class="col-md-8 col-lg-6">
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-4 text-center">
                        <h5 class="fw-bold mb-1"><?= t('Tracking Booking') ?></h5>
                        ...
                        <div class="d-flex justify-content-center align-items-center my-4 klook-tracker">
                            <div class="text-center">
                                ...
                                <small class="d-block" style="font-size: 10px;"><?= t('Booking') ?></small>
                            ...
                            <div class="text-center">
                                ...
                                <small class="d-block" style="font-size: 10px;"><?= t('Konfirmasi') ?></small>
                            </div>
                            <div class="d-flex align-items-center" style="width: 50px;"><div class="border-top border-2 <?= $booking['status'] === 'confirmed' ? 'border-success' : 'border-secondary' ?> w-100"></div></div>
                            <div class="text-center">
                                ...
                                <small class="d-block" style="font-size: 10px;"><?= t('Pembayaran') ?></small>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <small class="d-block" style="font-size: 10px;"><?= t('Selesai') ?></small>
                            </div>
                        </div>
                        ...
                        <div class="mb-0">
                            <?php if ($booking['status'] === 'pending'): ?>
                                <span class="badge bg-warning text-dark fs-6 px-4 py-2"><?= t('Menunggu Konfirmasi') ?></span>
                            <?php elseif ($booking['status'] === 'confirmed'): ?>
                                <span class="badge bg-success fs-6 px-4 py-2">✓ <?= t('Dikonfirmasi') ?></span>
                            <?php elseif ($booking['status'] === 'cancelled'): ?>
                                <span class="badge bg-danger fs-6 px-4 py-2">✕ <?= t('Dibatalkan') ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        <h6 class="fw-semibold mb-3"><?= t('Detail Pesanan') ?></h6>
                        <table class="table table-borderless mb-0 small">
                            <tr><td class="text-muted ps-0"><?= t('Paket Tour') ?></td><td class="fw-semibold"><?= e($booking['tour_title']) ?></td></tr>
                            <tr><td class="text-muted ps-0"><?= t('Nama') ?></td><td class="fw-semibold"><?= e($booking['name']) ?></td></tr>
                            <tr><td class="text-muted ps-0"><?= t('WhatsApp') ?></td><td class="fw-semibold"><?= e($booking['phone']) ?></td></tr>
                ...
                <p class="text-center mt-3">
                    <a href="tour-detail.php?slug=<?= e($booking['tour_slug']) ?>" class="text-decoration-none small"><i class="bi bi-arrow-left"></i> <?= t('Kembali ke halaman tour') ?></a>
                </p>
            </div>
        </div>
        <?php else: ?>
